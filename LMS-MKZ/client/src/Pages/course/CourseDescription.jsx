...
function CourseDescription() {
    ...
    return (
        <HomeLayout>
            <div className="min-h-screen flex flex-col lg:flex-row items-start gap-10 px-4 md:px-12 lg:px-20 py-12">
                ...
                >
                    ...
                    <div className="flex flex-col gap-4 mt-4">
                        <p className="font-semibold text-base md:text-lg text-gray-300">
                            Category:{" "}
                            <span className="text-yellow-400 font-bold">{state.category}</span>
                        </p>
                        <p className="font-semibold text-base md:text-lg text-gray-300">
                            Instructor:{" "}
                            <span className="text-yellow-400 font-bold">{state.createdBy}</span>
                        </p>
                    </div>
                ...
                <motion.div
                    ...
                    className="lg:w-1/2 w-full flex flex-col gap-6 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-6"
                >
                    <h1 className="font-extrabold text-3xl md:text-5xl bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent capitalize tracking-tight">
                        {state.title}
                    </h1>
