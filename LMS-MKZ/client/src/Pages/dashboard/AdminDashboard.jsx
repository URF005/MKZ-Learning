...
function AdminDashboard() {
    ...
    datasets: [
      {
        ...
        backgroundColor: ["#E4B122", "#22c55e"], // gold + green
        borderWidth: 1,
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        pointBackgroundColor: "#E4B122", // gold points
        tension: 0.4,
      },
    ],
  };
  ...
  return (
    <HomeLayout>
      <div className="flex flex-col gap-10 pt-6 mb-16 font-mulish">
        {/* Heading */}
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-center text-3xl md:text-4xl font-extrabold text-transparent bg-gradient-to-r from-[#E4B122] to-[#c9971a] bg-clip-text"
        >
          Admin Dashboard
        </motion.h1>
          ...
          {[
            {
              ...
              value: allUserCount,
              icon: <FaUsers className="text-[#E4B122] text-3xl md:text-4xl" />,
            },
            {
              label: "Subscribed Users",
              value: subscribedCount,
              icon: <FaUsers className="text-green-400 text-3xl md:text-4xl" />,
            },
            {
              label: "Subscriptions",
              value: allPayments?.count,
              icon: <FcSalesPerformance className="text-3xl md:text-4xl" />,
            },
            {
              label: "Total Revenue",
            ...
            >
              <h2 className="text-slate-300 font-semibold text-base md:text-lg">
                {stat.label}
              </h2>
            ...
            <tbody>
              {Courses?.map((course, idx) => (
                ...
                >
                  ...
                  <td
                    onClick={() =>
                      navigate(`/course/${course?.title}/${course?._id}/lectures`, {
                        state: Courses[idx],
                      })
                    }
                    className="px-3 md:px-4 py-2 md:py-3 font-medium text-[#E4B122] hover:underline cursor-pointer"
                  >
                    {course?.title}
                  </td>
