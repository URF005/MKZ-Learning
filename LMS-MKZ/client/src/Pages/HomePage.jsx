        ...
        <HomeLayout>
            ...
            <section className="py-16 px-4 sm:px-8 bg-gray-900 text-white">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                    {/* Featured Course */}
                    <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-yellow-500/20 transition">
                        <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80"
                            alt="Web Development Bootcamp" className="w-full h-48 sm:h-64 object-cover" />
                        <div className="p-6">
                            <h3 className="text-xl sm:text-2xl font-semibold">Web Development Bootcamp</h3>
                            <p className="text-gray-400 mt-2 text-sm sm:text-base">
                                Master HTML, CSS, JavaScript, and React to build full-stack applications from scratch.
                                This bootcamp also covers Node.js, Express, and MongoDB so you can create modern, scalable web apps.
                                Work on real-world projects, build a strong portfolio, and earn a certificate that proves your skills to employers.
                            </p>

                            <button className="mt-4 px-5 sm:px-6 py-2 bg-yellow-500 text-black rounded-lg hover:bg-yellow-400 transition">
                                Enroll Now
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {[
                            ...
                            <div key={idx} className="p-5 sm:p-6 bg-gray-800 rounded-lg hover:bg-gray-700 transition">
                                <img src={course.img} alt={course.title} className="h-28 sm:h-32 w-full object-cover rounded-md mb-4" />
                                <h4 className="font-semibold text-base sm:text-lg">{course.title}</h4>
                                <p className="text-gray-400 text-xs sm:text-sm mt-1">{course.desc}</p>
                                <button className="mt-3 px-4 py-2 bg-yellow-500 text-black rounded-lg text-sm hover:bg-yellow-400 transition">
                                    View
                                </button>
                            </div>
                        ))}
